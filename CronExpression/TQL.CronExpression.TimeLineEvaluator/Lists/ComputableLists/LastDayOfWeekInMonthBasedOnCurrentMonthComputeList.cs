...
namespace TQL.CronExpression.TimelineEvaluator.Lists.ComputableLists
{
    public class LastDayOfWeekInMonthBasedOnCurrentMonthComputeList : DateTimeBasedComputeList
    {
        ...
        ///     Firstly, Check difference between LastWeekDay and ExpectedWeekDay. It will measure how far your ExpectedWeekDay is
        ///     from LastWeekDay.
        ///     Secondly, compute days to remove from LastDay. It may occur overflow or underflow which means that it's jump to
        ///     next/prev week.
        ///     Formula:
